...
#### Controller SUC Type [controller_suctype]

Sets the controller as a Static Update Controller (SUC_BASIC), a Static Include Server (SUC_SERVER) or a standard primary controller (SUC_NONE) within the network.
